...
///   master checkbox — "내 텔레그램 봇으로 상태 보내기"
...
final class TelegramPaneViewController: NSViewController, NSTextFieldDelegate {
    ...
    override func loadView() {
        ...
        let masterTip = NSL("telegram.tip.master",
            "The master switch. Off means Argus sends nothing over the network at all. Setup fields and the test button below stay usable so you can wire things up first.")
        ...
        Glass.installPage([
            ...
            Glass.section(NSL("telegram.card.credentials", "Bot credentials"), [
                setupHelp,
                grid,
            ]),
            Glass.section(NSL("telegram.card.events", "Events"), [
                eventsHeader,
                eventsStack,
                testRow,
            ]),
