...
final class HistoryPaneViewController: TimedRefreshPaneViewController, NSTableViewDataSource, NSTableViewDelegate {
    ...
    override func loadView() {
        ...
        // Timeline, table and footer are all width-pinned to this stack, so the
        // pane stays one unit and gains the glass surface + page title instead.
        Glass.installFixedPage([Glass.wrap(stack)], in: root)
