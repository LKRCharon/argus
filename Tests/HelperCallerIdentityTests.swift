...
struct HelperCallerIdentityTests {
    ...
    static func main() {
        ...
        check(req.contains("identifier \"com.kairong.argus.hook\""),
        ...
        check(!req.contains("identifier \"com.kairong.argus\" "),
        ...
        check(HelperCallerIdentity.hookIdentifier == "com.kairong.argus.hook",
              "hookIdentifier must match build.sh `codesign --identifier com.kairong.argus.hook`")
